...
namespace libonvif
{
    ...
    class Data
    {
        public:
            ...
            {
                if (strcmp(data->xaddrs, rhs.data->xaddrs)) { return false; }
                else { return true; }
            }

            bool operator!=(const Data &rhs)
            {
                if (strcmp(data->xaddrs, rhs.data->xaddrs)) { return true; }
                else { return false; }
            }
            ...
            bool friend operator!=(const Data &lhs, const Data &rhs)
            {
                if (strcmp(lhs.data->xaddrs, rhs.data->xaddrs)) { return true; }
                else { return false; }
            }
            ...
            void UTCasLocal()
            {
                ...
                if (isUTC0 && datetimetype() == 'M') setDateTimeType('U');
            }
            ...
            void updateTime()
            {
                ...
                int length =
                    std::min(std::max((int)(str.str().length() - 2), 0), 1024);
                ...
                for (int i = 0; i < profiles.size(); i++)
                    {
                        if (strcmp(
                            ...
                            ))
                            {
                                ...
                                profiles[i].data->dhcp_enabled =
                                    data->dhcp_enabled;
                                profiles[i].data->prefix_length =
                                    data->prefix_length;
                            }
                    }
                ...
                try
                    {
                        ...
                        if (getProxyURI) { str << getProxyURI(arg); }
                        else
                            {
                                if (arg.length() > 7)
                ...
                if (key == "audio_sample_rates")
                    {
                        ...
                        data->audio_sample_rates[counters[d - 1]][counters[d]] =
                            i;
                        counters[d]++;
                    }
            ...
            {
                counters.pop_back();
                if (counters.size()) counters[counters.size() - 1]++;
                return true;
            }
            ...
            */
            ...
            bool getDisableAudio()
            {
                ...
                if (audio_bitrate() == 0) result = false;
                return result;
            }

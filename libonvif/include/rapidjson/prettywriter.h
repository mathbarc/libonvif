    ...
    public:
        ...
        */
        ...
        explicit PrettyWriter(
            ...
            : Base(allocator, levelDepth), indentChar_(' '),
              indentCharCount_(4), formatOptions_(kFormatDefault)
        {
        }
        ...
        /*! \param indentChar       Character for indentation. Must be
           ...
           indentCharCount  Number of indent characters for each indentation
        ...
        */
        ...
        /*!
           ...
           PrettyWriter::RawValue(), the result json may not be indented
           correctly.
        */
    ...
    protected:
                    ...
                    if (level->inArray)
                        {
                            if (level->valueCount > 0)
                                {
                                    Base::os_->Put(','
                                    ); // add comma if it is not the first
                                       // element in array
        ...
        void WriteIndent()
        {
            size_t count =
                ...
                indentCharCount_;
            PutN(
                *Base::os_, static_cast<typename OutputStream::Ch>(indentChar_),
                count
            );
        }

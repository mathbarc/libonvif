...
struct Specification {
    ...
    {
        return (
            (draft >= kDraftMin && draft <= kDraftMax) && ((oapi == kVersionNone) || (oapi >= kVersionMin && oapi <= kVersionMax))
        );
    }
    SchemaDraft draft;
    OpenApiVersion oapi;
            ...
            , nullable_(false)
        {
            ...
            if (const ValueType* v = GetMember(value, GetEnumString())) {
                if (v->IsArray() && v->Size() > 0) {
                    enum_ = static_cast<uint64_t*>(allocator_->Malloc(
        ...
        RAPIDJSON_FORCEINLINE bool EndValue(Context& context) const
        {
            ...
            if (context.patternPropertiesValidatorCount > 0) {
                ...
                if (context.objectPatternValidatorType != Context::kPatternValidatorOnly)
                    otherValid = context.patternPropertiesValidators[--count]
                                     ->IsValid();
                ...
                for (SizeType sourceIndex = 0;
                    ...
                    if (context.propertyExist[sourceIndex]) {
                        if (source.dependencies) {
                            ...
                            ISchemaValidator* dependenciesValidator = context.validators
                                                                          [source
                                                                               .dependenciesValidatorIndex];
...
public:
    ...
    GetRemoteDocument(const Ch* uri, SizeType length)
        = 0;
                        ...
                        if (const GenericSchemaDocument* remoteDocument = remoteProvider_
                            ...
                            if (len <= 1 || s[1] == '/') {
                                ...
                                if (!pointer
                                    ...
                                    // Get the
                                    // subschema
                                    if (const SchemaType* sc = remoteDocument
                                                                   ->GetSchema(
                                                                       pointer
                                                                   )) {
                                        if (schema)
    ...
    void EndMissingDependentProperties(const SValue& sourceName)
    {
        if (!missingDependents_.Empty()) {
            ...
            AddErrorSchemaLocation(
                error, schemaRef.Append(sourceName.GetString(), sourceName.GetStringLength(), &GetInvalidSchemaPointer().GetAllocator())
            );
    ...
    bool BeginValue()
    {
        ...
        if (schemaStack_.Empty())
            ...
            if (count > 0) {
                ...
                SizeType& validatorCount = CurrentContext()
                                               .patternPropertiesValidatorCount;
        ...
        *documentStack_.template Push<Ch>() = '\0';
        ...
        if (!schemaStack_.Empty()) {
            ...
            if (hasher && context.valueUniqueness) {
                ...
                if (!a)
                    CurrentContext().arrayElementHashCodes = a = new (GetStateAllocator().Malloc(
                ...
                for (typename HashCodeArray::ConstValueIterator
                    ...
                    if (itr->GetUint64() == h) {
                        ...
                        if (GetContinueOnErrors()) {
                            ...
                            while (
                                !documentStack_.Empty() && *documentStack_.template Pop<Ch>(1) != '/'
                            )
                                ;
                        }
                        RAPIDJSON_INVALID_KEYWORD_RETURN(

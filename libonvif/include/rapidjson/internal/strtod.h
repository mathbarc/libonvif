...
namespace internal
{
    ...
    inline bool
    StrtodDiyFp(const Ch *decimals, int dLen, int dExp, double *result)
    {
        ...
        for (; i < dLen; i++)
            {
                ...
                significand = significand * 10u +
                              static_cast<unsigned>(decimals[i] - Ch('0'));
            }
        ...
        if (actualExp != dExp)
            {
                static const DiyFp kPow10[] = {
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0xa0000000, 0x00000000), -60
                    ), // 10^1
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0xc8000000, 0x00000000), -57
                    ), // 10^2
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0xfa000000, 0x00000000), -54
                    ), // 10^3
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0x9c400000, 0x00000000), -50
                    ), // 10^4
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0xc3500000, 0x00000000), -47
                    ), // 10^5
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0xf4240000, 0x00000000), -44
                    ), // 10^6
                    DiyFp(
                        RAPIDJSON_UINT64_C2(0x98968000, 0x00000000), -40
                    ) // 10^7
                };
    ...
    template <typename Ch>
    inline double
    StrtodBigInteger(double approx, const Ch *decimals, int dLen, int dExp)
    {
    ...
    inline double StrtodFullPrecision(
        double d, int p, const Ch *decimals, size_t length,
    ...
    )
    {
        ...
        // Use approximation from StrtodDiyFp and make adjustment with

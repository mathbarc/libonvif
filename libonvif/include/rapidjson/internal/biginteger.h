        ...
        public:
            ...
            BigInteger(const Ch *decimals, size_t length) : count_(1)
            {
                ...
                while (length >= kMaxDigitPerIteration)
                    {
                        AppendDecimal64(
                            decimals + i, decimals + i + kMaxDigitPerIteration
                        );
                ...
                if (this != &rhs)
                    {
                        count_ = rhs.count_;
                        std::memcpy(
                            digits_, rhs.digits_, count_ * sizeof(Type)
                        );
                    }
                return *this;
            }
            ...
            BigInteger &operator<<=(size_t shift)
            {
                ...
                if (interShift == 0)
                    {
                        std::memmove(
                            digits_ + offset, digits_, count_ * sizeof(Type)
                        );
                        count_ += offset;
                    }
                else
            ...
            BigInteger &MultiplyPow5(unsigned exp)
            {
                ...
                for (; exp >= 27; exp -= 27)
                    *this *=
                        RAPIDJSON_UINT64_C2(0X6765C793, 0XFA10079D); // 5^27
                for (; exp >= 13; exp -= 13)

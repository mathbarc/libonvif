                    ...
                    case kStringType:
                        if (rhs.data_.f.flags == kConstStringFlag &&
                            !copyConstStrings)
                            {
                                ...
                                data_ =
                                    *reinterpret_cast<const Data *>(&rhs.data_);
                            }
                        else
                            SetStringRaw(
                                StringRef(
    ...
    private:
        ...
        enum
        {
            ...
            kNumberUintFlag =
                static_cast<int>(kNumberType) |
                static_cast<int>(
                    kNumberFlag | kUintFlag | kUint64Flag | kInt64Flag
                ),
            ...
            kNumberAnyFlag = static_cast<int>(kNumberType) |
                             static_cast<int>(
                                 kNumberFlag | kIntFlag | kInt64Flag |
        ...
        struct ShortString
        {
                ...
                {
                    MaxChars =
                        sizeof(static_cast<Flag *>(0)->payload) / sizeof(Ch),
                    MaxSize = MaxChars - 1,
                    LenPos = MaxSize
                };
                Ch str[MaxChars];
    ...
    public:
        ...
        */
        ...
        ~GenericDocument()
        {
            ...
            if (ownAllocator_) { ValueType::SetNull(); }
            Destroy();
        }

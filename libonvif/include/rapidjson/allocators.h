...
class MemoryPoolAllocator {
    ...
    static const size_t kDefaultChunkCapacity = RAPIDJSON_ALLOCATOR_DEFAULT_CHUNK_CAPACITY; //!< Default chunk
                                                                                            //!< capacity.

public:
    static const bool kNeedFree = false; //!< Tell users that no need to call Free() with this
                                         //!< allocator. (concept Allocator)
    static const bool kRefCounted = true; //!< Tell users that this allocator is reference counted on
                                          //!< copy
    ...
    */
    ...
    void* Malloc(size_t size)
    {
        ...
        if (RAPIDJSON_UNLIKELY(
                shared_->chunkHead->size + size > shared_->chunkHead->capacity
            ))
